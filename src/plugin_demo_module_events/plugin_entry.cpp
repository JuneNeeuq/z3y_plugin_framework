 ...
 * @brief `plugin_demo_module_events` 插件的入口点文件。
 * @author Yue Liu
 * @date 2025-08-16
...
#include "framework/z3y_define_impl.h"  // 包含 Z3Y_DEFINE_PLUGIN_ENTRY
  ...
  * [受众：框架维护者]
  * 此宏将自动执行此插件 (DLL)
  * 中定义的所有 `Z3Y_AUTO_REGISTER_...` 宏，包括：
  * 1. `demo_event_sender.cpp` 中的 `Z3Y_AUTO_REGISTER_SERVICE`
  * 2. `demo_events_features.cpp` 中的 `Z3Y_AUTO_REGISTER_COMPONENT`
  */
